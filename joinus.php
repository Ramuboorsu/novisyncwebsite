    ...
    session_destroy();
      ...
      $lname = $_POST['lastname'];
       ...
       $des = $_POST['description'];
         ...
         $sel = mysqli_query($con,"SELECT * FROM `novidetails` WHERE `number` = '$mobile'");
...
<br>
<h2 style="color:black; text-align:center;">JOIN US !</h2>
<h2></h2> 
...
<div class="container form-top">
    <div class="row">
      ...
      <form  action="" name="myform" method="post" onsubmit="return validateForm();" enctype="multipart/form-data">
 ...
 <div class="form-group">
	...
	<option value="Management">Management</option>
              ...
              <div class="form-group">
                ...
                <input id="fileUpload" type="file" name="file" onchange="return fileValidation()" required>
