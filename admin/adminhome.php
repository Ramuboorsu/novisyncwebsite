...
<body>
 <header id="header">
    <div class="container-fluid">
      ...
      <div id="logo">
 <a href="adminhome.php" style="font-size:38px; color:#03C4EB; text-decoration:none;"><img src="../img/Novisync.svg">Novisync</a>       <!-- Uncomment below if you prefer to use a text image -->
