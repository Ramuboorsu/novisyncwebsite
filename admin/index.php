...
<div class="row align-items-center h-100">
    <div class="col-3 mx-auto">
        <div class="text-center">
            <img id="profile-img" class="rounded-circle profile-img-card" src="../img/Novisync.svg" style="margin-top:100px;"/>
...
if(isset($_POST['login']))
{
 ...
 if($user == 'admin')
 {
	$sel = mysqli_query($con,"SELECT * FROM `tbl_users` WHERE `username` = '$user' AND `password` = '$pwd' ");
	...
	$sel = mysqli_query($con,"SELECT * FROM `novireg` WHERE `username` = '$user' AND `password` = '$pwd' ");
